package com.firstservlet.restful2;
	...
	public class GetExampleClient {
	    public static final String BASE_URI = "http://localhost:8080/webservices2";
	    ...
	    public static void main(String[] args) {
	        ...
	        WebResource nameResource = resource.path("com/firstservlet/restful").path(PATH_NAME + name);
	        System.out.println("Client Response \n" + getClientResponse(nameResource));
	        System.out.println("Response \n" + getResponse(nameResource) + "\n\n");
	        WebResource ageResource = resource.path("com/firstservlet/restful").path(PATH_ADDRESS + address);
